...
[![My Skills](https://skillicons.dev/icons?i=aws,javascript,typescript,react,vue,nodejs,expressjs,nestjs,graphql,docker,mysql,mongodb,knex,vscode,webpack,regex,git,jest,&perline=6)](https://skillicons.dev)
